...
public class PropertyDO {
    ...
    private String beloneToClassName;
    ...
    public enum Column {
        ...
        beloneToClassName("belone_to_class_name", "beloneToClassName", "VARCHAR", false),
        propertyClassName("property_class_name", "propertyClassName", "VARCHAR", false),
